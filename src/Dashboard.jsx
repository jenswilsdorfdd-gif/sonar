    ...
    >
      ...
      >
        ...
        <div>
          ...
          <input
            type="date"
            value={eingangsdatum}
            onChange={(e) => setEingangsdatum(e.target.value)}
            style={inputStyle}
          />
        </div>
        ...
        <div>
          ...
          <input
            type="date"
            value={fristExtern}
            onChange={(e) => setFristExtern(e.target.value)}
            style={inputStyle}
          />
        </div>
        ...
        <div>
          ...
          >
            ...
            <span style={{ display: 'flex', gap: '4px' }}>
              <button
                type="button"
                onClick={() => setzeWiedervorlageTage(14)}
                style={quickBtnStyle}
              >
                +2 Wo
              </button>
              <button
                type="button"
                onClick={() => setzeWiedervorlageTage(28)}
                style={quickBtnStyle}
              >
                +4 Wo
              </button>
              <button
                type="button"
                onClick={() => setzeWiedervorlageTage(30)}
                style={quickBtnStyle}
              >
                +1 Mo
              </button>
        ...
        <div>
          ...
          <input
            ...
            style={{ ...inputStyle, padding: '7px', backgroundColor: '#fff' }}
          />
        </div>
        ...
        <button
          ...
          style={{
            padding: '12px',
            background: laedt ? '#95a5a6' : '#27ae60',
            color: '#fff',
            border: 'none',
            borderRadius: '6px',
          ...
          >
            {fristenWarnungen.map((w) => (
              <li key={`warn-${w.id}`} style={{ marginBottom: '5px' }}>
                ...
                - Frist: {formatDatum(w.frist_extern)}
                <span
                  style={{
                    color: '#e74c3c',
                    fontWeight: 'bold',
                ...
                >
                  {w.tageUebrig < 0
                    ? `(Bereits ${Math.abs(w.tageUebrig)} Tage überfällig!)`
                    : w.tageUebrig === 0
                    ? '(Verfristet HEUTE!)'
                    : `(Verfristet in ${w.tageUebrig} Tag(en))`}
                </span>
              </li>
            ))}
          </ul>
      ...
      >
        ...
        <button
          ...
          style={{
            padding: '8px 15px',
            background: zeigeErledigte ? '#34495e' : '#ecf0f1',
            color: zeigeErledigte ? '#fff' : '#333',
            border: 'none',
            borderRadius: '4px',
            cursor: 'pointer',
            fontWeight: 'bold',
                  ...
                  {bearbeiteId === vorgang.id ? (
                    <>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="text"
                          value={editAktenzeichen}
                          onChange={(e) => setEditAktenzeichen(e.target.value)}
                      ...
                      <td style={{ padding: '5px' }}>
                        <input
                          type="text"
                          value={editThema}
                          onChange={(e) => setEditThema(e.target.value)}
                          list="bescheid-list"
                          style={{ width: '90px', padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="date"
                          value={editEingangsdatum}
                          onChange={(e) => setEditEingangsdatum(e.target.value)}
                          style={{ padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                      ...
                      <td style={{ padding: '5px' }}>
                        <input
                          type="text"
                          value={editKanal}
                          onChange={(e) => setEditKanal(e.target.value)}
                          list="versandart-list"
                          style={{ width: '60px', padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="date"
                          value={editFristExtern}
                          onChange={(e) => setEditFristExtern(e.target.value)}
                          style={{ padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="date"
                          value={editWiedervorlage}
                          onChange={(e) => setEditWiedervorlage(e.target.value)}
                          style={{ padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="text"
                          value={editUeberwachung}
                          onChange={(e) => setEditUeberwachung(e.target.value)}
                          style={{ width: '80px', padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '5px' }}>
                        <input
                          type="date"
                          value={editErledigtAm}
                          onChange={(e) => setEditErledigtAm(e.target.value)}
                          style={{ padding: '4px' }}
                        />
                      </td>
                      <td style={{ padding: '10px' }}>{vorgang.status}</td>
                      <td style={{ padding: '10px' }}>
                        {vorgang.dokument_url ? '📄' : '-'}
                      </td>
                      <td
                        style={{
                          padding: '10px',
                      ...
                      >
                        <button
                          onClick={() => speichereBearbeitung(vorgang.id)}
                          style={{
                            padding: '6px',
                            background: '#2ecc71',
                            color: 'white',
                    ...
                    <>
                      ...
                      <td style={{ padding: '10px' }}>
                        {formatDatum(vorgang.eingangsdatum)}
                      </td>
                      <td style={{ padding: '10px' }}>
                        {vorgang.aktion || '-'}
                      </td>
                      ...
                      <td
                        style={{
                          padding: '10px',
                          color: isKritisch ? '#e74c3c' : 'inherit',
                          fontWeight: isKritisch ? 'bold' : 'normal',
                        }}
                      >
                        {formatDatum(vorgang.frist_extern)}
                      </td>
                      <td style={{ padding: '10px' }}>
                        {formatDatum(vorgang.wiedervorlage)}
                      </td>
                      <td style={{ padding: '10px' }}>
                        {vorgang.ueberwachung || '-'}
                      </td>
                      <td style={{ padding: '10px' }}>
                        {formatDatum(vorgang.erledigt_am)}
                      </td>
                      <td style={{ padding: '10px' }}>
                        <select
                          value={vorgang.status || 'Offen'}
                          onChange={(e) =>
                            aendereStatus(vorgang.id, e.target.value)
                          }
                          style={{
                            padding: '4px 8px',
                            borderRadius: '12px',
                      ...
                      >
                        <button
                          onClick={() => erstelleFolgeaktion(vorgang)}
                          title="Folgeaktion anlegen"
                          style={{
                            padding: '6px',
                            background: '#f39c12',
                            color: 'white',
                        ...
                        <button
                          onClick={() => startBearbeiten(vorgang)}
                          title="Bearbeiten"
                          style={{
                            padding: '6px',
                            background: '#3498db',
                        ...
                        <button
                          onClick={() => loescheEintrag(vorgang.id)}
                          title="Löschen"
                          style={{
                            padding: '6px',
                            background: '#e74c3c',
